    ...
    <div class="rounded-2xl border bg-card shadow-sm flex flex-col gap-5 p-5">
        ...
        <template v-else-if="data">
            ...
            <div class="grid grid-cols-3 gap-3">
                ...
                <button
                    class="rounded-xl bg-emerald-50 dark:bg-emerald-950/30 p-3 flex flex-col gap-0.5 text-left hover:bg-emerald-100 dark:hover:bg-emerald-900/40 transition-colors cursor-pointer"
                    @click="fetchList('submitted', 'ALL')"
                >
                    <p class="text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 uppercase tracking-wide flex items-center gap-1">
                    ...
                    <p class="text-xs text-emerald-600 dark:text-emerald-400 font-semibold">{{ data.submitted_pct }}%</p>
                </button>
                <button
                    class="rounded-xl bg-red-50 dark:bg-red-950/30 p-3 flex flex-col gap-0.5 text-left hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors cursor-pointer"
                    @click="fetchList('not_submitted', 'ALL')"
                >
                    <p class="text-[10px] font-semibold text-red-500 dark:text-red-400 uppercase tracking-wide flex items-center gap-1">
                        <FileX class="h-3 w-3" /> Not Submitted
                    </p>
                    <p class="text-2xl font-extrabold text-red-600 dark:text-red-400">{{ data.not_submitted.toLocaleString() }}</p>
                    <p class="text-xs text-red-500 dark:text-red-400 font-semibold">{{ data.not_submitted_pct }}%</p>
                </button>
            </div>
