...
import { Activity, Pencil, PlusCircle, Trash2 } from 'lucide-vue-next';
            ...
            <div class="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="text-xs text-muted-foreground">
                        Internal daily monitoring — programs added, edited, and deleted. Not linked in navigation.
                    </p>
                </div>
            </div>
                    ...
                    <div v-for="entry in logs.data" :key="entry.id" class="flex items-center gap-3 px-4 py-2.5">
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="truncate text-xs font-semibold">
                                ...
                                <span v-if="entry.program_code" class="font-normal text-muted-foreground">({{ entry.program_code }})</span>
                            </p>
