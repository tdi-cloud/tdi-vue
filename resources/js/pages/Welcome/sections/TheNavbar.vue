        ...
        <div class="mobile-menu" :class="{ 'mobile-menu--open': mobileMenuOpen }">
            ...
            <div class="mobile-menu__actions">
                <template v-if="auth?.user">
                    ...
                    <button type="button" class="btn btn--outline" @click="logout"><LogOut class="mr-1 h-4 w-4" /> Log out</button>
                </template>
                <template v-else>
...
import { ChartPie, ChevronsUpDown, GraduationCap, LogOut, Settings } from 'lucide-vue-next';
...
.user-menu__dropdown {
    ...
    border-radius: 12px;
    min-width: 240px;
    box-shadow: 0 10px 30px rgba(15, 28, 72, 0.18);
    overflow: hidden;
    padding: 0.4rem;
}
.user-menu__header {
