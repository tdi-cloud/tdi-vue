        ...
        <section class="about" id="about" ref="aboutRef">
            <div class="about__inner">
                ...
                <div class="about__text">
                    ...
                    <p class="about__body">
                        TESDA Development Institute serves as the learning arm of TESDA, creating meaningful development experiences that build
                        capability, confidence, and public service excellence.
                    </p>
            ...
            <div class="scholarships__inner">
                <div class="scholarships__text">
                    ...
                    <p class="scholarships__body">
                        Discover opportunities that support advanced study, deeper expertise, and broader professional capability.
                    </p>
...
function checkEligibility() {
    ...
    if (goodRating && enoughService) {
        ...
        eligibilityResult.value = {
            type: 'result--info',
            icon: 'ℹ️',
            message: 'You may not yet meet all criteria. Keep growing — check again after your next review.',
        };
    }
}
...
onMounted(() => {
    ...
    // Hero animation
    setTimeout(() => {
        wordVisible.value[0] = true;
    }, 300);
    setTimeout(() => {
        wordVisible.value[1] = true;
    }, 600);
    setTimeout(() => {
        wordVisible.value[2] = true;
    }, 900);
    setTimeout(() => {
