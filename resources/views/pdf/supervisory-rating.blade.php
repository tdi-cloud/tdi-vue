...
<body>
    ...
    <table class="meta">
        <tr>
            <td style="width:40%"><span class="bold">Name:</span> {{ $form['name'] ?? $a->supervisor_name }}</td>
            <td style="width:30%"><span class="bold">Office:</span> {{ $form['office'] ?? '' }}</td>
            <td style="width:30%"><span class="bold">Division:</span> {{ $form['division'] ?? '' }}</td>
        </tr>
        <tr>
