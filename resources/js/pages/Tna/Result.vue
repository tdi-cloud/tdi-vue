        ...
        <div class="relative z-10 mx-auto max-w-6xl space-y-6">
            ...
            <div class="rounded-2xl bg-white p-8 shadow-xl">
                <div class="flex flex-wrap items-start justify-between gap-3">
                    <div>
                        <h1 class="text-2xl font-bold tracking-tight text-gray-900">TRAINING NEEDS ANALYSIS OF CURRENT COMPETENCIES</h1>
            ...
            <div class="rounded-2xl bg-white p-8 shadow-xl">
                ...
                <p class="mt-1 text-sm text-gray-500">Optional attachments — the auto-generated PDF above remains the official record.</p>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-5">
                <div class="rounded-2xl bg-white p-6 shadow-xl lg:col-span-3">
                    ...
                    <p class="mt-2 text-sm leading-relaxed text-gray-600">
                        Based on the ratings provided by the respondents, the employee/official must undergo training programs that will address
                        deficiencies on the following competencies:
                    </p>
                    <ol v-if="priority.length" class="mt-4 space-y-2">
                        <li v-for="(p, i) in priority" :key="p.unit" class="flex items-start gap-3 rounded-xl bg-sky-50/70 p-3">
                            <span
            ...
            <div class="overflow-x-auto rounded-2xl bg-white p-6 shadow-xl">
                <table class="w-full border-collapse text-sm">
                    <thead>
                        ...
                        <tr class="border-b border-gray-200 text-[10px] italic text-gray-400">
                            <th class="border-l border-gray-200 px-2 py-1">Sf</th>
                            <th class="px-2 py-1">Sp</th>
                            <th class="border-l border-gray-200 px-2 py-1">Sf</th>
                            <th class="px-2 py-1">Sp</th>
                            <th class="border-l border-gray-200 px-2 py-1">Sf</th>
                            <th class="px-2 py-1">Sp</th>
                ...
                <p class="mt-3 text-xs text-gray-400"><b>Sf</b> = Self rating · <b>Sp</b> = Supervisor rating</p>
            </div>
            ...
            <div class="rounded-2xl bg-white p-8 shadow-xl">
                ...
                <div class="mt-4">
                    ...
                    <ol v-if="revisedPriority.length" class="mt-3 space-y-2">
                        <li v-for="(p, i) in revisedPriority" :key="p.unit" class="flex items-start gap-3 rounded-xl bg-purple-50/70 p-3">
                            <span
                                class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-purple-600 text-xs font-bold text-white"
                            >
                                {{ i + 1 }}
                            </span>
                            <div class="min-w-0">
